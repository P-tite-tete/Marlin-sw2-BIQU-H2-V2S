...
#define STRING_CONFIG_H_AUTHOR "(P'tite Tête, SW X2 2.0.9.5 H2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "P'tite tête - Artillery SWX2 H2 REVO"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 16.13
  #define DEFAULT_bedKi 0.70
  #define DEFAULT_bedKd 246.97
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -32, -30, -1.5 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS), 50 }
